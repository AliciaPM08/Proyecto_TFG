...
/**
 * Controlador JavaFX para la vista del equipo Sevilla Femenino.
...
public class ConSevillaP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoSevilla.entrenador"));
        labelEstadio.setText(recursos.getString("equipoSevilla.estadio"));
        labelFundacion.setText(recursos.getString("equipoSevilla.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Sevilla", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Sevilla", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Sevilla", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Sevilla FC/" + jugadora.getNombre() + ".jpg";
