...
public class ConDeporP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoDepor.entrenador"));
        labelEstadio.setText(recursos.getString("equipoDepor.estadio"));
        labelFundacion.setText(recursos.getString("equipoDepor.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Dep La Coruña", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Dep La Coruña", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Dep La Coruña", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Deportivo Abanca/" + jugadora.getNombre() + ".jpg";
