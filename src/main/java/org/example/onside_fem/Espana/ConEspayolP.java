...
/**
 * Controlador JavaFX para la vista del equipo Espanyol Femenino.
...
public class ConEspayolP {
    ...
    private void traducirUI() {
        ...
        labelCopaPrimera.setText(recursos.getString("equipoEspanyol.titulo1"));
        labelEntrenador.setText(recursos.getString("equipoEspanyol.entrenador"));
        labelEstadio.setText(recursos.getString("equipoEspanyol.estadio"));
        labelFundacion.setText(recursos.getString("equipoEspanyol.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Espanyol", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Espanyol", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Espanyol", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/RC Espanyol/" + jugadora.getNombre() + ".jpg";
