...
/**
 * Controlador JavaFX para la vista del equipo Madrid CFF Femenino.
...
public class ConMadridP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoMadrid.entrenador"));
        labelEstadio.setText(recursos.getString("equipoMadrid.estadio"));
        labelFundacion.setText(recursos.getString("equipoMadrid.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Madrid CFF", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Madrid CFF", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Madrid CFF", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Madrid CFF/" + jugadora.getNombre() + ".jpg";
