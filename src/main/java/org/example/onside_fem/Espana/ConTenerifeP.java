...
/**
 * Controlador JavaFX para la vista del equipo Costa Adeje Tenerife Femenino.
...
public class ConTenerifeP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoTenerife.entrenador"));
        labelEstadio.setText(recursos.getString("equipoTenerife.estadio"));
        labelFundacion.setText(recursos.getString("equipoTenerife.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("UDG Tenerifes", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("UDG Tenerife", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("UDG Tenerife", nombreLimpio);
