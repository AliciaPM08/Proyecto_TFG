...
public class ConRMadridP {
    ...
    private void cargarJugadoresEnTab(String abreviaturaPosicion, Tab tab) {
        List<Jugadora> jugadores = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Real Madrid", abreviaturaPosicion);
    ...
    private ImageView cargarFotoJugadora(Jugadora jugadora, String liga) {
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Real Madrid CF/"
