...
public class ConRMadridP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoRMadrid.entrenador"));
        labelEstadio.setText(recursos.getString("equipoRMadrid.estadio"));
        labelFundacion.setText(recursos.getString("equipoRMadrid.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Real Madrid", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Real Madrid", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Real Madrid", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Real Madrid CF/" + jugadora.getNombre() + ".jpg";
