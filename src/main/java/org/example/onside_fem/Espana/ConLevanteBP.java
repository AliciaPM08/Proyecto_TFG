...
public class ConLevanteBP {
    ...
    private void cargarJugadoresEnTab(String abreviaturaPosicion, Tab tab) {
        List<Jugadora> jugadores = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Levante Badalona", abreviaturaPosicion);
    ...
    private ImageView cargarFotoJugadora(Jugadora jugadora, String liga) {
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/FC Levante Badalona/"
