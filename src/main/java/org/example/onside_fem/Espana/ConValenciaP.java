...
/**
 * Controlador JavaFX para la vista del equipo Valencia Femenino.
...
public class ConValenciaP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoValencia.entrenador"));
        labelEstadio.setText(recursos.getString("equipoValencia.estadio"));
        labelFundacion.setText(recursos.getString("equipoValencia.fundacion"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Valencia", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Valencia", nombreLimpio);
