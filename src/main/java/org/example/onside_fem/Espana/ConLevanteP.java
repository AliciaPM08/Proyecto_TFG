...
/**
 * Controlador JavaFX para la vista del equipo Levante Femenino.
...
public class ConLevanteP {
    ...
    @FXML private Label labelEstadio, labelEntrenador, labelFundacion, labelSupercopa, labelCopaPrimera, labelChampion;
    ...
    private void traducirUI() {
        ...
        labelCopaPrimera.setText(recursos.getString("equipoLevante.titulo1"));
        labelSupercopa.setText(recursos.getString("equipoLevante.titulo3"));
        labelEntrenador.setText(recursos.getString("equipoLevante.entrenador"));
        labelEstadio.setText(recursos.getString("equipoLevante.estadio"));
        labelFundacion.setText(recursos.getString("equipoLevante.fundacion"));
    ...
    /**
     * Inicializa la tabla de estadísticas con los datos.
     */
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Levante", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Levante", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Levante", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Levante UD/" + jugadora.getNombre() + ".jpg";
