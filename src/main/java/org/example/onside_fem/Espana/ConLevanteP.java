...
public class ConLevanteP {
    ...
    private void cargarJugadoresEnTab(String abreviaturaPosicion, Tab tab) {
        List<Jugadora> jugadores = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Levante", abreviaturaPosicion);
    ...
    private ImageView cargarFotoJugadora(Jugadora jugadora, String liga) {
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Levante UD/"
