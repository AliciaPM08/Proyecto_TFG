...
/**
 * Controlador JavaFX para la vista del equipo Athletico Club Femenino.
...
public class ConBilbaoP {
    ...
    @FXML private Label labelEstadio, labelEntrenador, labelFundacion, labelSupercopa, labelCopaPrimera;
    ...
    private void traducirUI() {
        ...
        labelCopaPrimera.setText(recursos.getString("equipoAthletic.titulo1"));
        labelEntrenador.setText(recursos.getString("equipoAthletic.entrenador"));
        labelEstadio.setText(recursos.getString("equipoAthletic.estadio"));
        labelFundacion.setText(recursos.getString("equipoAthletic.fundacion"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Athletic Club", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Athletic Club", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Athletic_Club/" + jugadora.getNombre() + ".jpg";
