...
public class ConGranadaP {
    ...
    private void cargarJugadoresEnTab(String abreviaturaPosicion, Tab tab) {
        List<Jugadora> jugadores = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Granada", abreviaturaPosicion);
    ...
    private ImageView cargarFotoJugadora(Jugadora jugadora, String liga) {
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Granada CF/"
