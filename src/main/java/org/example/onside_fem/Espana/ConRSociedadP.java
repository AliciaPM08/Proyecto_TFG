...
public class ConRSociedadP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoRSociedad.entrenador"));
        labelEstadio.setText(recursos.getString("equipoRSociedad.estadio"));
        labelFundacion.setText(recursos.getString("equipoRSociedad.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Real Sociedad", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Real Sociedad", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Real Sociedad", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga_Española/Jugadoras/Real Sociedad/" + jugadora.getNombre() + ".jpg";
