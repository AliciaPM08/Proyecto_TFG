...
/**
 * Controlador JavaFX para la vista del equipo Eibar Femenino.
...
public class ConEibarP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoEibar.entrenador"));
        labelEstadio.setText(recursos.getString("equipoEibar.estadio"));
        labelFundacion.setText(recursos.getString("equipoEibar.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Eibar", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Eibar", nombreLimpio);
