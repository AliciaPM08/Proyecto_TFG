...
/**
 * Controlador JavaFX para la vista del equipo Barcelona Femenino.
...
public class ConBarsaP {
    ...
    private void traducirUI() {
        ...
        labelCopaPrimera.setText(recursos.getString("equipoBarcelona.titulo1"));
        labelSupercopa.setText(recursos.getString("equipoBarcelona.titulo3"));
        labelEntrenador.setText(recursos.getString("equipoBarcelona.entrenador"));
        labelEstadio.setText(recursos.getString("equipoBarcelona.estadio"));
        labelFundacion.setText(recursos.getString("equipoBarcelona.fundacion"));
        labelChampion.setText(recursos.getString("equipoBarcelona.titulo2"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Barcelona", "Finetwork Liga F");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Barcelona", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Barcelona", nombreLimpio);
