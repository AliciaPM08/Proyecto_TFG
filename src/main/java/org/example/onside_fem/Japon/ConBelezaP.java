...
public class ConBelezaP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoBeleza.entrenador"));
        labelEstadio.setText(recursos.getString("equipoBeleza.estadio"));
        labelFundacion.setText(recursos.getString("equipoBeleza.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Beleza", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Beleza", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Beleza", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Beleza/" + jugadora.getNombre() + ".png";
