...
public class ConVegaltaP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoVegalta.entrenador"));
        labelEstadio.setText(recursos.getString("equipoVegalta.estadio"));
        labelFundacion.setText(recursos.getString("equipoVegalta.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Vegalta Sendai", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Vegalta Sendai", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Vegalta Sendai", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Vegalta Sendai/" + jugadora.getNombre() + ".png";
