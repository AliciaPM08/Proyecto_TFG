...
public class ConUrawaP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoUrawa.entrenador"));
        labelEstadio.setText(recursos.getString("equipoUrawa.estadio"));
        labelFundacion.setText(recursos.getString("equipoUrawa.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Urawa Reds", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Urawa Reds", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Urawa Reds", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Urawa Reds/" + jugadora.getNombre() + ".png";
