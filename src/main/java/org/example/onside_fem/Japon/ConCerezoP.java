...
public class ConCerezoP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoCerezo.entrenador"));
        labelEstadio.setText(recursos.getString("equipoCerezo.estadio"));
        labelFundacion.setText(recursos.getString("equipoCerezo.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Cerezo", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Cerezo", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Cerezo", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Cerezo/" + jugadora.getNombre() + ".png";
