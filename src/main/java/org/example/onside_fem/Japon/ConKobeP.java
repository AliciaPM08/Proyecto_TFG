...
public class ConKobeP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoKobe.entrenador"));
        labelEstadio.setText(recursos.getString("equipoKobe.estadio"));
        labelFundacion.setText(recursos.getString("equipoKobe.fundacion"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Kobe Leonessa", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Kobe Leonesa/" + jugadora.getNombre() + ".png";
