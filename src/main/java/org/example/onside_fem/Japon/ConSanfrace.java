...
public class ConSanfrace {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoSanfrece.entrenador"));
        labelEstadio.setText(recursos.getString("equipoSanfrece.estadio"));
        labelFundacion.setText(recursos.getString("equipoSanfrece.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Sanfrecce Hiroshima", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Sanfrecce Hiroshima", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Sanfrecce Hiroshima", nombreLimpio);
                mostrarInfoEnPanel(j, "Liga Japonesa");
            }
        });
    }
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Sanfrece Hiroshima/" + jugadora.getNombre() + ".png";
