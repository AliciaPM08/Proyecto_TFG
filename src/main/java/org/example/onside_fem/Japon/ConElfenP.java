...
public class ConElfenP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoElfen.entrenador"));
        labelEstadio.setText(recursos.getString("equipoElfen.estadio"));
        labelFundacion.setText(recursos.getString("equipoElfen.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("AS Elfen Saitama", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("AS Elfen Saitama", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("AS Elfen Saitama", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/AS Elfen Saitama/" + jugadora.getNombre() + ".png";
