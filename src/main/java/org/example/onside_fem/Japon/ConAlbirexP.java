...
public class ConAlbirexP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoAlbirex.entrenador"));
        labelEstadio.setText(recursos.getString("equipoAlbirex.estadio"));
        labelFundacion.setText(recursos.getString("equipoAlbirex.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Albirex Niigata", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Albirex Niigata", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Albirex Niigata", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Albirex Nigata/" + jugadora.getNombre() + ".png";
