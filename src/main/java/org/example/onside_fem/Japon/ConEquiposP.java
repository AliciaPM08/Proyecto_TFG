...
public class ConEquiposP {
    ...
    private void inicializarEquipos() {
        ...
        equipoPantallas.put("ivCentral", "/org/example/onside_fem/Australia/PCentral.fxml");
        equipoPantallas.put("ivMelbourneS", "/org/example/onside_fem/Australia/PMSydney.fxml");
        equipoPantallas.put("ivMelbourneV", "/org/example/onside_fem/Australia/PMVictory.fxml");
        equipoPantallas.put("ivNewcastle", "/org/example/onside_fem/Australia/PNewcastle.fxml");
        equipoPantallas.put("ivPerth", "/org/example/onside_fem/Australia/PPerth.fxml");
        equipoPantallas.put("ivSydney", "/org/example/onside_fem/Australia/PSydney.fxml");
        equipoPantallas.put("ivWPhoenix", "/org/example/onside_fem/Australia/PWPhoenix.fxml");
        equipoPantallas.put("ivWUnited", "/org/example/onside_fem/Australia/PWUnited.fxml");
        equipoPantallas.put("ivWSydney", "/org/example/onside_fem/Australia/PWSydney.fxml");
