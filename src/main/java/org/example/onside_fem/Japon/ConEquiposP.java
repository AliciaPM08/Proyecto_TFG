...
public class ConEquiposP {
    ...
    private void inicializarClasifiacion() {
        btnClasificacion.setOnAction(e -> cargarPantalla("/org/example/onside_fem/Japon/PClasificacionJaponesa.fxml"));
    }


    private void inicializarEquipos() {
        equipoPantallas.put("ivAlbirex", "/org/example/onside_fem/Japon/PAlbirex.fxml");
        equipoPantallas.put("ivElfen","/org/example/onside_fem/Japon/PElfen.fxml");
        equipoPantallas.put("ivBeleza", "/org/example/onside_fem/Japon/PBeleza.fxml");
        equipoPantallas.put("ivCerezo", "/org/example/onside_fem/Japon/PCerezo.fxml");
        equipoPantallas.put("ivChiba", "/org/example/onside_fem/Japon/PChiba.fxml");
        equipoPantallas.put("ivKobe", "/org/example/onside_fem/Japon/PKobe.fxml");
        equipoPantallas.put("ivNagano", "/org/example/onside_fem/Japon/PNagano.fxml");
        equipoPantallas.put("ivNojima", "/org/example/onside_fem/Japon/PNojima.fxml");
        equipoPantallas.put("ivOmaya", "/org/example/onside_fem/Japon/POmiya.fxml");
        equipoPantallas.put("ivSanfrecce", "/org/example/onside_fem/Japon/PSanfrace.fxml");
        equipoPantallas.put("ivUrawa", "/org/example/onside_fem/Japon/PUrawa.fxml");
        equipoPantallas.put("ivVegalta", "/org/example/onside_fem/Japon/PVegalta.fxml");
