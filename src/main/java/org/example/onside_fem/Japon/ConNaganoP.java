...
public class ConNaganoP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoNagano.entrenador"));
        labelEstadio.setText(recursos.getString("equipoNagano.estadio"));
        labelFundacion.setText(recursos.getString("equipoNagano.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Nagano Parceiro", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Nagano Parceiro", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Nagano Parceiro", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Nagano Parceiro/" + jugadora.getNombre() + ".png";
