...
public class ConNojima {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoNojima.entrenador"));
        labelEstadio.setText(recursos.getString("equipoNojima.estadio"));
        labelFundacion.setText(recursos.getString("equipoNojima.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Nojima Stella", "Yogibo WE League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Nojima Stella", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Nojima Stella", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Japonesa/Jugadoras/Najima Stella/" + jugadora.getNombre() + ".png";
