...
public class ConPerthP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoPerth.entrenador"));
        labelEstadio.setText(recursos.getString("equipoPerth.estadio"));
        labelFundacion.setText(recursos.getString("equipoPerth.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Perth Glory", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Perth Glory", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Perth Glory", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Perth Glory/" + jugadora.getNombre() + ".jpg";
