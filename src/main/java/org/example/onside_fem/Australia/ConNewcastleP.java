...
public class ConNewcastleP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoNewcastle.entrenador"));
        labelEstadio.setText(recursos.getString("equipoNewcastle.estadio"));
        labelFundacion.setText(recursos.getString("equipoNewcastle.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Newcastle Jets", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Newcastle Jets", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Newcastle Jets", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Newcastle Jets/" + jugadora.getNombre() + ".jpg";
