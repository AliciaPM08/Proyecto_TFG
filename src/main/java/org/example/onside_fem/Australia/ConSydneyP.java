...
public class ConSydneyP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoSydney.entrenador"));
        labelEstadio.setText(recursos.getString("equipoSydney.estadio"));
        labelFundacion.setText(recursos.getString("equipoSydney.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Sydney FC", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Sydney FC", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Sydney FC", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Sidney FC/" + jugadora.getNombre() + ".jpeg";
