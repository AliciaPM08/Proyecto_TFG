...
public class ConMVictoryP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoMVictory.entrenador"));
        labelEstadio.setText(recursos.getString("equipoMVictory.estadio"));
        labelFundacion.setText(recursos.getString("equipoMVictory.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Melb Victory", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Melb Victory", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Melb Victory", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Melb Victory/" + jugadora.getNombre() + ".jpg";
