...
public class ConBrisbaneP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoBrisbane.entrenador"));
        labelEstadio.setText(recursos.getString("equipoBrisbane.estadio"));
        labelFundacion.setText(recursos.getString("equipoBrisbane.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Brisbane Roar", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Brisbane Roar", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Brisbane Roar", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Brisbane Roar/" + jugadora.getNombre() + ".jpg";
