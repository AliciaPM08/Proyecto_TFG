...
public class ConCentralP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoCentral.entrenador"));
        labelEstadio.setText(recursos.getString("equipoCentral.estadio"));
        labelFundacion.setText(recursos.getString("equipoCentral.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Central Coast Mariners", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Central Coast Mariners", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Central Coast Mariners", nombreLimpio);
                mostrarInfoEnPanel(j, "Liga Australiana");
            }
        });
    }
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Central Coast Mariners/" + jugadora.getNombre() + ".jpg";
