...
public class ConMSydneyP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoMCity.entrenador"));
        labelEstadio.setText(recursos.getString("equipoMCity.estadio"));
        labelFundacion.setText(recursos.getString("equipoMCity.fundacion"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Melb City", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Melb City", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Melb Sindey/" + jugadora.getNombre() + ".jpg";
