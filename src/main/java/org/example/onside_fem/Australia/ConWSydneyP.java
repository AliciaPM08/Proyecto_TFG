...
public class ConWSydneyP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoWSydney.entrenador"));
        labelEstadio.setText(recursos.getString("equipoWSydney.estadio"));
        labelFundacion.setText(recursos.getString("equipoWSydney.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("W Sydney", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("W Sydney", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("W Sydney", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/W Sindey/" + jugadora.getNombre() + ".jpg";
