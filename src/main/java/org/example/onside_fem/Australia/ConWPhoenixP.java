...
public class ConWPhoenixP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoWellignton.entrenador"));
        labelEstadio.setText(recursos.getString("equipoWellignton.estadio"));
        labelFundacion.setText(recursos.getString("equipoWellignton.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Wellington Phoenix", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Wellington Phoenix", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Wellington Phoenix", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Wellington Phoenix/" + jugadora.getNombre() + ".jpeg";
