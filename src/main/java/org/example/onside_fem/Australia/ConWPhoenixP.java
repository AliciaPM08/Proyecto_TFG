...
//        // SELECCIONES
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Wellington Phoenix", newVal);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        String baseRuta = "/Imagenes/Liga Australiana/Jugadoras/Wellington Phoenix/" + jugadora.getNombre();
        InputStream inputStream = getClass().getResourceAsStream(baseRuta + ".jpeg");
