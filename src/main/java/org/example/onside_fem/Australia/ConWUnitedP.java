...
public class ConWUnitedP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoWUnited.entrenador"));
        labelEstadio.setText(recursos.getString("equipoWUnited.estadio"));
        labelFundacion.setText(recursos.getString("equipoWUnited.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Western United", "Liberty A-League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Western United", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Western United", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Australiana/Jugadoras/Western United/" + jugadora.getNombre() + ".jpeg";
