...
public class ConOrlandoP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoPride.entrenador"));
        labelEstadio.setText(recursos.getString("equipoPride.estadio"));
        labelFundacion.setText(recursos.getString("equipoPride.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Pride", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Pride", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Pride", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Pride/" + jugadora.getNombre() + ".png";
