...
public class ConLousvilleP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoLouisville.entrenador"));
        labelEstadio.setText(recursos.getString("equipoLouisville.estadio"));
        labelFundacion.setText(recursos.getString("equipoLouisville.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Louisville", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Louisville", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Louisville", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Lousville/" + jugadora.getNombre() + ".jpg";
