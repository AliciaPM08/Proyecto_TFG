...
public class ConChicagoP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoChicago.entrenador"));
        labelEstadio.setText(recursos.getString("equipoChicago.estadio"));
        labelFundacion.setText(recursos.getString("equipoChicago.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Red Stars", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Red Stars", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Red Stars", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Red Start/" + jugadora.getNombre() + ".jpg";
