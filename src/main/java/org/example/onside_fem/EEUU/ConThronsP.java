...
public class ConThronsP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoThorns.entrenador"));
        labelEstadio.setText(recursos.getString("equipoThorns.estadio"));
        labelFundacion.setText(recursos.getString("equipoThorns.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Thorns", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Thorns", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Thorns", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Throms/" + jugadora.getNombre() + ".png";
