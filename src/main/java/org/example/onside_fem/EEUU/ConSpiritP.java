...
public class ConSpiritP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoSpirit.entrenador"));
        labelEstadio.setText(recursos.getString("equipoSpirit.estadio"));
        labelFundacion.setText(recursos.getString("equipoSpirit.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Spirit", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Spirit", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Spirit", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Spirit/" + jugadora.getNombre() + ".jpg";
