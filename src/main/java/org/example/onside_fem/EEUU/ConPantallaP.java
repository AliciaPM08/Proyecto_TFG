...
public class ConPantallaP {
    ...
    private void traducirUI() {
        ...
        labelTitulo1.setText(recursos.getString("label.titulo1EEUU"));
        labelTitulo2.setText(recursos.getString("label.titulo2EEUU"));
        labelTitulo3.setText(recursos.getString("label.titulo3EEUU"));
        labelNoticia1.setText(recursos.getString("label.noticia1EEUU"));
        labelNoticia2.setText(recursos.getString("label.noticia2EEUU"));
        labelNoticia3.setText(recursos.getString("label.noticia3EEUU"));
    }
