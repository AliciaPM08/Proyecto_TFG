...
public class ConGothamP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoGotham.entrenador"));
        labelEstadio.setText(recursos.getString("equipoGotham.estadio"));
        labelFundacion.setText(recursos.getString("equipoGotham.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Gotham FC", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Gotham FC", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Gotham FC", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Gotham/" + jugadora.getNombre() + ".jpg";
