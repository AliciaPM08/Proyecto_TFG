...
public class ConCurrentP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoCurrent.entrenador"));
        labelEstadio.setText(recursos.getString("equipoCurrent.estadio"));
        labelFundacion.setText(recursos.getString("equipoCurrent.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Current", "National Womens Soccer League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Current", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Current", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Estadunidense/Jugadoras/Current/" + jugadora.getNombre() + ".png";
