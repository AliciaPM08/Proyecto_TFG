...
public class ConBrasil {
    ...
    @FXML Label labelBrasil, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelBrasil.setText(recursos.getString("label.Brasil"));
        labelEntrenador.setText(recursos.getString("label.entrenadorBRA"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        List<JugadoraSeleccion> jugadoras = jugadoraDAO.obtenerJugadoresPorSeleccionYPosicion("Brasil", posicion);
        ...
        if (listView.getProperties().get("listenerAdded") == null) {
            listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                if (newVal != null) {
                    JugadoraSeleccion j = jugadoraDAO.obtenerJugadoraSeleccionPorNombre("Brasil", newVal);
                    mostrarInfoEnPanel(j, "Brasil");
                }
            });
    ...
    private void mostrarInfoEnPanel(JugadoraSeleccion jugadora, String seleccion) {
        ...
        String baseRuta = "/Imagenes/Selecciones/Jugadoras/Brasil/" + jugadora.getNombre_jugadora();
