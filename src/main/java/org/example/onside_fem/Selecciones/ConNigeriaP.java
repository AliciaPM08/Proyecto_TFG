...
public class ConNigeriaP {
    ...
    @FXML Label labelNigeria, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelNigeria.setText(recursos.getString("label.Nigeria"));
        labelEntrenador.setText(recursos.getString("label.entrenadorNIG"));
