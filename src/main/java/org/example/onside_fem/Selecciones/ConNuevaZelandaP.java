...
public class ConNuevaZelandaP {
    ...
    @FXML Label labelNZelanda, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelNZelanda.setText(recursos.getString("label.NZelanda"));
        labelEntrenador.setText(recursos.getString("label.entrenadorNZE"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        List<JugadoraSeleccion> jugadoras = jugadoraDAO.obtenerJugadoresPorSeleccionYPosicion("Nueva Zelanda", posicion);
        ...
        if (listView.getProperties().get("listenerAdded") == null) {
            listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                if (newVal != null) {
                    JugadoraSeleccion j = jugadoraDAO.obtenerJugadoraSeleccionPorNombre("Nueva Zelanda", newVal);
                    mostrarInfoEnPanel(j, "Nueva Zelanda");
                }
            });
    ...
    private void mostrarInfoEnPanel(JugadoraSeleccion jugadora, String seleccion) {
        ...
        String baseRuta = "/Imagenes/Selecciones/Jugadoras/Nueva Zelanda/" + jugadora.getNombre_jugadora();
