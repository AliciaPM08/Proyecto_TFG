...
public class CoSueciaP {
    ...
    @FXML Label labelSuecia, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelSuecia.setText(recursos.getString("label.Suecia"));
        labelEntrenador.setText(recursos.getString("label.entrenadorSUE"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        List<JugadoraSeleccion> jugadoras = jugadoraDAO.obtenerJugadoresPorSeleccionYPosicion("Suecia", posicion);
        ...
        if (listView.getProperties().get("listenerAdded") == null) {
            listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                if (newVal != null) {
                    JugadoraSeleccion j = jugadoraDAO.obtenerJugadoraSeleccionPorNombre("Suecia", newVal);
                    mostrarInfoEnPanel(j, "Suecia");
                }
            });
    ...
    private void mostrarInfoEnPanel(JugadoraSeleccion jugadora, String seleccion) {
        ...
        String baseRuta = "/Imagenes/Selecciones/Jugadoras/Suecia/" + jugadora.getNombre_jugadora();
