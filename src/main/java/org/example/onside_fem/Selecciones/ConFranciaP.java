...
public class ConFranciaP {
    ...
    @FXML Label labelFrancia, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelFrancia.setText(recursos.getString("label.Francia"));
        labelEntrenador.setText(recursos.getString("label.entrenadorFRA"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        List<JugadoraSeleccion> jugadoras = jugadoraDAO.obtenerJugadoresPorSeleccionYPosicion("Francia", posicion);
        ...
        if (listView.getProperties().get("listenerAdded") == null) {
            listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                if (newVal != null) {
                    JugadoraSeleccion j = jugadoraDAO.obtenerJugadoraSeleccionPorNombre("Francia", newVal);
                    mostrarInfoEnPanel(j, "Francia");
                }
            });
    ...
    private void mostrarInfoEnPanel(JugadoraSeleccion jugadora, String seleccion) {
        ...
        String baseRuta = "/Imagenes/Selecciones/Jugadoras/Francia/" + jugadora.getNombre_jugadora();
