...
public class ConSudafricaP {
    ...
    @FXML Label labelSudafrica, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelSudafrica.setText(recursos.getString("label.Sudafrica"));
        labelEntrenador.setText(recursos.getString("label.entrenadorSUD"));
