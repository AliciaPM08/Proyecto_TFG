...
public class ConInglateraP {
    ...
    @FXML Label labelInglaterra, labelEntrenador, labelEquipacion, labelRanking, labelPalmares, labelConvocatoria, footer;
    ...
    private void traducirUI() {
        ...
        labelInglaterra.setText(recursos.getString("label.Inglaterra"));
        labelEntrenador.setText(recursos.getString("label.entrenadorING"));
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        ...
        List<JugadoraSeleccion> jugadoras = jugadoraDAO.obtenerJugadoresPorSeleccionYPosicion("Inglaterra", posicion);
        ...
        if (listView.getProperties().get("listenerAdded") == null) {
            listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                if (newVal != null) {
                    JugadoraSeleccion j = jugadoraDAO.obtenerJugadoraSeleccionPorNombre("Inglaterra", newVal);
                    mostrarInfoEnPanel(j, "Inglaterra");
                }
            });
    ...
    private void mostrarInfoEnPanel(JugadoraSeleccion jugadora, String seleccion) {
        ...
        String baseRuta = "/Imagenes/Selecciones/Jugadoras/Inglaterra/" + jugadora.getNombre_jugadora();
