...
public class ConManCityP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoManCity.entrenador"));
        labelEstadio.setText(recursos.getString("equipoManCity.estadio"));
        labelFundacion.setText(recursos.getString("equipoManCity.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Manchester City", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Manchester City", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Manchester City", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Manchester City/" + jugadora.getNombre() + ".jpeg";
