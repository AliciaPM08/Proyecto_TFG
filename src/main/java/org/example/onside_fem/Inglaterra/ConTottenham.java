...
public class ConTottenham {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoTottenham.entrenador"));
        labelEstadio.setText(recursos.getString("equipoTottenham.estadio"));
        labelFundacion.setText(recursos.getString("equipoTottenham.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Tottenham", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Tottenham", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Tottenham", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Tottenham/" + jugadora.getNombre() + ".jpeg";
