...
public class ConBrighton {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoBrigthon.entrenador"));
        labelEstadio.setText(recursos.getString("equipoBrigthon.estadio"));
        labelFundacion.setText(recursos.getString("equipoBrigthon.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Brighton", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Brighton", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Brighton", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Brighton/" + jugadora.getNombre() + ".jpeg";
