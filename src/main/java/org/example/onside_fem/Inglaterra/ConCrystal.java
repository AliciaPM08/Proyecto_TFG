...
public class ConCrystal {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoCrystal.entrenador"));
        labelEstadio.setText(recursos.getString("equipoCrystal.estadio"));
        labelFundacion.setText(recursos.getString("equipoCrystal.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Crystal Palace", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Crystal Palace", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Crystal Palace", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Crystal Palace/" + jugadora.getNombre() + ".jpeg";
