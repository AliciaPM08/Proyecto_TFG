...
public class ConPantallaP {
    ...
    private void traducirUI() {
        ...
        labelTitulo1.setText(recursos.getString("label.titulo1ING"));
        labelTitulo2.setText(recursos.getString("label.titulo2ING"));
        labelTitulo3.setText(recursos.getString("label.titulo3ING"));
        labelNoticia1.setText(recursos.getString("label.noticia1ING"));
        labelNoticia2.setText(recursos.getString("label.noticia2ING"));
        labelNoticia3.setText(recursos.getString("label.noticia3ING"));
    }
    ...
    private void inicializarClasifiacion() {
        btnClasificacion.setOnAction(e -> cargarPantalla("/org/example/onside_fem/Inglaterra/PClasificacionInglaterra.fxml"));
    }
