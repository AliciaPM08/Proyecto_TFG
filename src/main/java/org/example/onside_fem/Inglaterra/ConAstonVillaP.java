...
public class ConAstonVillaP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoAstonVilla.entrenador"));
        labelEstadio.setText(recursos.getString("equipoAstonVilla.estadio"));
        labelFundacion.setText(recursos.getString("equipoAstonVilla.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Aston Villa", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Aston Villa", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Aston Villa", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Aston Villa/" + jugadora.getNombre() + ".jpeg";
