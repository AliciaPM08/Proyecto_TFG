...
public class ConChelsea {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoChelsea.entrenador"));
        labelEstadio.setText(recursos.getString("equipoChelsea.estadio"));
        labelFundacion.setText(recursos.getString("equipoChelsea.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Chelsea", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Chelsea", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Chelsea", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Chelsea/" + jugadora.getNombre() + ".jpeg";
