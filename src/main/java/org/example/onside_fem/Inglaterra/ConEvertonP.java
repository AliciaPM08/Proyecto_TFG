...
public class ConEvertonP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoEverton.entrenador"));
        labelEstadio.setText(recursos.getString("equipoEverton.estadio"));
        labelFundacion.setText(recursos.getString("equipoEverton.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Everton", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Everton", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Everton", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Everton/" + jugadora.getNombre() + ".jpeg";
