...
public class ConLiverpoolP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoLiverpool.entrenador"));
        labelEstadio.setText(recursos.getString("equipoLiverpool.estadio"));
        labelFundacion.setText(recursos.getString("equipoLiverpool.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Liverpool", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Liverpool", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Liverpool", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Liverpool/" + jugadora.getNombre() + ".jpeg";
