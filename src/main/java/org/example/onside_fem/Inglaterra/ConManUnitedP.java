package org.example.onside_fem.Inglaterra;
...
public class ConManUnitedP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoManUnited.entrenador"));
        labelEstadio.setText(recursos.getString("equipoManUnited.estadio"));
        labelFundacion.setText(recursos.getString("equipoManUnited.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Manchester United", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Manchester United", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Manchester United", nombreLimpio);
                mostrarInfoEnPanel(j, "Liga Inglesa");
            }
        });
    }
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Manchester United/" + jugadora.getNombre() + ".jpeg";
