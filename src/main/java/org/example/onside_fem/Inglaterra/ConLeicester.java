...
public class ConLeicester {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoLeicester.entrenador"));
        labelEstadio.setText(recursos.getString("equipoLeicester.estadio"));
        labelFundacion.setText(recursos.getString("equipoLeicester.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Leicester City", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Leicester City", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Leicester City", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Leicester City/" + jugadora.getNombre() + ".jpeg";
