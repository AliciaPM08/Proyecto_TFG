...
public class ConArsenalP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoArsenal.entrenador"));
        labelEstadio.setText(recursos.getString("equipoArsenal.estadio"));
        labelFundacion.setText(recursos.getString("equipoArsenal.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Arsenal", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Arsenal", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Arsenal", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/Arsenal/" + jugadora.getNombre() + ".jpeg";
