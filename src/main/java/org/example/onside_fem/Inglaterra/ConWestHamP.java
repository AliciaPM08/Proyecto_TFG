...
public class ConWestHamP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoWest.entrenador"));
        labelEstadio.setText(recursos.getString("equipoWest.estadio"));
        labelFundacion.setText(recursos.getString("equipoWest.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("West Ham", "Womens Super League");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("West Ham", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("West Ham", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Inglesa/Jugadoras/West Ham/" + jugadora.getNombre() + ".jpeg";
