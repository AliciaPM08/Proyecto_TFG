...
public class ConPantallaPrincipal {
    ...
    private void inicializarMenuInicio() {
        menuInicio.setOnShowing(e -> cargarPantalla("/org/example/onside_fem/FXML/PantallaPrincipal.fxml"));
    }

    private void inicializarRutas() {
        // LIGAS
        ligaPantallas.put("Finetwork Liga F", "/org/example/onside_fem/PPLigaEspañola.fxml");
