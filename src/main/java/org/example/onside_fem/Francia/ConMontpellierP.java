...
public class ConMontpellierP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoMontpellier.entrenador"));
        labelEstadio.setText(recursos.getString("equipoMontpellier.estadio"));
        labelFundacion.setText(recursos.getString("equipoMontpellier.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Montpellier", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Montpellier", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Montpellier", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Montpellier/" + jugadora.getNombre() + ".jpg";
