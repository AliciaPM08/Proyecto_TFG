...
public class ConNantesP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoNantes.entrenador"));
        labelEstadio.setText(recursos.getString("equipoNantes.estadio"));
        labelFundacion.setText(recursos.getString("equipoNantes.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Nantes", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Nantes", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Nantes", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Nantes/" + jugadora.getNombre() + ".jpg";
