...
public class ConParisP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoParisFC.entrenador"));
        labelEstadio.setText(recursos.getString("equipoParisFC.estadio"));
        labelFundacion.setText(recursos.getString("equipoParisFC.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Paris FC", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Paris FC", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Paris FC", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Paris Fc/" + jugadora.getNombre() + ".png";
