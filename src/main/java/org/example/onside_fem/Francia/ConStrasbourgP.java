...
public class ConStrasbourgP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoStrasbourg.entrenador"));
        labelEstadio.setText(recursos.getString("equipoStrasbourg.estadio"));
        labelFundacion.setText(recursos.getString("equipoStrasbourg.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Strasbourg", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Strasbourg", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Strasbourg", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Strasbourg/" + jugadora.getNombre() + ".jpg";
