...
public class ConEtienne {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoEtienne.entrenador"));
        labelEstadio.setText(recursos.getString("equipoEtienne.estadio"));
        labelFundacion.setText(recursos.getString("equipoEtienne.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Saint-Etienne", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Saint-Etienne", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Saint-Etienne", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Saint Etienne/" + jugadora.getNombre() + ".png";
