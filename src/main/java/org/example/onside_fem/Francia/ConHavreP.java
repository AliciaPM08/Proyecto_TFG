...
public class ConHavreP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoLeHavre.entrenador"));
        labelEstadio.setText(recursos.getString("equipoLeHavre.estadio"));
        labelFundacion.setText(recursos.getString("equipoLeHavre.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Le Havre", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Le Havre", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Le Havre", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Le Havre/" + jugadora.getNombre() + ".jpg";
