...
public class ConGuingamp {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoGuingamp.entrenador"));
        labelEstadio.setText(recursos.getString("equipoGuingamp.estadio"));
        labelFundacion.setText(recursos.getString("equipoGuingamp.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Guingamp", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Guingamp", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Guingamp", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Guingamp/" + jugadora.getNombre() + ".jpg";
