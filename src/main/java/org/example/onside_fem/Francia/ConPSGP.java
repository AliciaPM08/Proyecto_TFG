...
public class ConPSGP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoPSG.entrenador"));
        labelEstadio.setText(recursos.getString("equipoPSG.estadio"));
        labelFundacion.setText(recursos.getString("equipoPSG.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Paris S-G", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Paris S-G", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Paris S-G", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Paris SG/" + jugadora.getNombre() + ".png";
