...
public class ConLyonP {
    ...
    @FXML private Label labelSupercopa, labelChampion;
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoLyon.entrenador"));
        labelEstadio.setText(recursos.getString("equipoLyon.estadio"));
        labelFundacion.setText(recursos.getString("equipoLyon.fundacion"));
        labelChampion.setText(recursos.getString("equipoLyon.champion"));
        labelSupercopa.setText(recursos.getString("equipoLyon.supercopa"));
    ...
    private void inicializarClasifiacion() {
        btnClasifiacion.setOnAction(e -> cargarPantalla("/org/example/onside_fem/Francia/PClasificacionFrancia.fxml"));
    }

    /**
     * Inicializa la tabla de estadísticas.
     */
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Lyon", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Lyon", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Lyon", nombreLimpio);
                mostrarInfoEnPanel(j, "Liga Francesa");
            }
        });
    }
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Lyon/" + jugadora.getNombre() + ".jpg";
