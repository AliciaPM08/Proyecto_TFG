...
public class ConReimsP {
    ...
    private void traducirUI() {
        ...
        labelEntrenador.setText(recursos.getString("equipoStadeReims.entrenador"));
        labelEstadio.setText(recursos.getString("equipoStadeReims.estadio"));
        labelFundacion.setText(recursos.getString("equipoStadeReims.fundacion"));
    ...
    private void inicializarTablaEstadisticas() {
        ...
        Estadisticas estadisticas = new EstadisticasDAO().obtenerEstadisticas("Stade de Reims", "Arkema Première Ligue");
    ...
    private void cargarListaJugadoras(String posicion, ListView<String> listView) {
        List<Jugadora> jugadoras = jugadoraDAO.obtenerJugadoresPorEquipoYPosicion("Stade de Reims", posicion);
        ...
        listView.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                Jugadora j = jugadoraDAO.obtenerJugadoraPorNombre("Stade de Reims", nombreLimpio);
    ...
    private void mostrarInfoEnPanel(Jugadora jugadora, String liga) {
        ...
        // Imagen
        String rutaImagen = "/Imagenes/Liga Francesa/Jugadoras/Stade de Reims/" + jugadora.getNombre() + ".png";
