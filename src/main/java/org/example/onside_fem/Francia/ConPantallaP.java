...
public class ConPantallaP {
    ...
    private void traducirUI() {
        ...
        labelTitulo1.setText(recursos.getString("label.titulo1FRA"));
        labelTitulo2.setText(recursos.getString("label.titulo2FRA"));
        labelTitulo3.setText(recursos.getString("label.titulo3FRA"));
        labelNoticia1.setText(recursos.getString("label.noticia1FRA"));
        labelNoticia2.setText(recursos.getString("label.noticia2FRA"));
        labelNoticia3.setText(recursos.getString("label.noticia3FRA"));
    }
